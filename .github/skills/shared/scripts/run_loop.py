...
generate_report_module = importlib.import_module("scripts.generate_report")
generate_html = generate_report_module.generate_html
improve_description_module = importlib.import_module("scripts.improve_description")
improve_description = improve_description_module.improve_description
...
parse_skill_md = utils_module.parse_skill_md
